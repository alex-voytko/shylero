const templates = [
    {
      ...
      template: `
        <a href="{{ wishlist.url }}" class="wk-link wk-link--{{ wishlist.state }}" title="{{ locale.view_wishlist }}">
          ...
          {% if wishlist.item_count != 0 %}<span class="wk-link__count">{{ wishlist.item_count }}</span>{% endif %}
        </a>
      `,
    },
    {
                ...
                {% unless limit and item_count > limit %}
                  ...
                  <div>
                    <div class="wk-grid__item {% if onsale %}wk-product--sale{% endif %}" data-wk-item="{{ product.wishlist_item_id }}">
                      ...
                      <product-item data-product-id="{{product.id}}" class="product-item">
                        <div class="product-item__image-wrapper">
                          <a href="{{product.url}}" class="product-item__aspect-ratio aspect-ratio aspect-ratio--square" style="padding-bottom: 56.25%; --aspect-ratio: 1.7777777777777777">
                            <img class="product-item__primary-image" loading="lazy" src="{{ product.featured_image | img_url }}" alt="{{product.featured_image.alt}}">
                          </a>
                        </div>
                        <div class="product-item__info">
                          <div class="product-item-meta">
                            <a href="{{product.url}}" class="product-item-meta__title">Beach Bag XL | Waterproof (IP64) | L22"xH15"xW6" (56x38x15cm) | Top YKK® Zip</a>
